      ...
      <div className="fixed bottom-6 left-0 right-0 z-40 flex justify-center gap-3 px-4 lg:hidden">
        <a
          ...
          className="flex-1 max-w-[170px] flex items-center justify-center gap-2 bg-gradient-to-r from-[#B71C1C] to-[#D32F2F]
                     text-white font-outfit font-semibold text-sm py-3.5 shadow-glow
                     hover:shadow-glow-lg transition-shadow uppercase tracking-wider"
        >
          <Phone className="w-4 h-4" />
          Call
        </a>
        <a
          ...
          className="flex-1 max-w-[170px] flex items-center justify-center gap-2 bg-[#25D366]
                     text-white font-outfit font-semibold text-sm py-3.5 shadow-lg
                     hover:bg-[#20b858] transition-colors uppercase tracking-wider"
        >
